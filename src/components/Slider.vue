    ...
    <v-layout row>
      <v-carousel class="carousel_master_p">
        <v-carousel-item>
          <v-container>
            <v-layout>
             <v-flex xs12 sm12 sm12 class="p10">
               <v-card>
                 <a href="#">
                   <div class="product-image-wrapper">
                     <div class="single-products">
...
.carousel_master_p .carousel__left {
    left: 5px;
    border-radius: 50%;
    background: #ddd;
}
.carousel_master_p .carousel__controls{
